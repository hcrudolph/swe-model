<div class="tariffs index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tariff['Tariff']['id']), array(), __('Are you sure you want to delete # %s?', $tariff['Tariff']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
