...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 26. Dez 2014 um 18:16
...
--
-- AUTO_INCREMENT for table `accounts_certificates`
--
ALTER TABLE `accounts_certificates`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `accounts_dates`
--
ALTER TABLE `accounts_dates`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `accounts_trainings`
--
ALTER TABLE `accounts_trainings`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
